...
func (_Erc20 *Erc20Caller) SUPPLYCAP(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Erc20.contract.Call(opts, &out, "SUPPLY_CAP")
...
//
// Solidity: function SUPPLY_CAP() view returns(uint256)
func (_Erc20 *Erc20Session) SUPPLYCAP() (*big.Int, error) {
	return _Erc20.Contract.SUPPLYCAP(&_Erc20.CallOpts)
}

// SUPPLYCAP is a free data retrieval call binding the contract method 0x0cfccc83.
//
// Solidity: function SUPPLY_CAP() view returns(uint256)
func (_Erc20 *Erc20CallerSession) SUPPLYCAP() (*big.Int, error) {
	return _Erc20.Contract.SUPPLYCAP(&_Erc20.CallOpts)
}
